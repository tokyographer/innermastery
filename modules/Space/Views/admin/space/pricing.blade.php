                        ...
                        <div class="item" data-number="{{$key}}">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label>
                                        <input @if(!is_default_lang()) disabled @endif type="checkbox" min="0" name="extra_price[{{$key}}][add_quantity]" value="on" @if($extra_price['add_quantity'] ?? '') checked @endif >
                                        {{__("Agregar cantidades")}}
                                    </label>
                                    <input name="extra_price[{{$key}}][quantity]" type="hidden" value="1"/>
                                </div>
                                <div class="col-md-1">
                                    @if(is_default_lang())
