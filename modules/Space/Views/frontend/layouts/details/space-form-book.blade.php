    ...
    <div class="bravo_single_book">
        <div id="bravo_space_book_app" v-cloak>
            ...
            <div class="form-book" :class="{'d-none':enquiry_type!='book'}">
                <div class="form-content">
                    ...
                    <div class="form-section-group form-group" v-if="extra_price.length">
                        ...
                        <div class="form-group " v-for="(type,index) in extra_price">
                            ...
                            <div class="row" style="justify-content: center;align-items: center;" v-if="type.add_quantity">
                                <div class="form-group form-guest-search">
                                    <div class="input-number-group">
                                        <i class="icon ion-ios-remove-circle-outline" @click="minusExtraPrice(index)"></i>
                                        <span class="input"><input type="number" v-model="type.quantity" min="1"/></span>
                                        <i class="icon ion-ios-add-circle-outline" @click="addExtraPrice(index)"></i>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div v-html="html"></div>
                @if($user->roles[0]->only_client == 1)
                    <div class="col-md-12 mb-3 form-section-group form-group" style="border-top: 1px solid #d7dce3;">
                        <label >{{__("Add purchase to another user")}} </label>
                        <select name="customer_id" class="form-control" v-model="customer_id">
