        ...
        <div class="filter-div d-flex justify-content-between">
            ...
            <div class="col-left">
                <form method="get" action="" class="filter-form filter-form-right d-flex justify-content-end">
                    @csrf
                    <?php
                        $user = !empty(Request()->member_id) ? App\User::find(Request()->member_id) : false;
                        \App\Helpers\AdminForm::select2('member_id', [
                            'configs' => [
                                'ajax'        => [
                    ...
                    <table class="table table-hover bravo-list-item">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr>
                                ...
                                <td>
                                    {{$row->agent ? $row->agent->first_name . ' ' . $row->agent->last_name : __("No Agent") }}
                                </td>
