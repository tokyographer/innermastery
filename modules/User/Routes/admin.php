...
Route::get('/transfer/list','UserController@transfer_list')->name("user.admin.transfer_list");
Route::get('/transfer','UserController@transfer')->name("user.admin.transfer");
Route::post('/transfer','UserController@transfer_store')->name("user.admin.transfer_store");
...
Route::group(['prefix'=>'wallet'],function (){
    ...
    Route::get('/remove-credit/{id}','WalletController@removeCredit')->name('user.admin.wallet.removeCredit');
    Route::post('/add-credit/{id}','WalletController@store')->name('user.admin.wallet.store');
    Route::post('/remove-credit/{id}','WalletController@removestore')->name('user.admin.wallet.removestore');
    ...
    Route::get('/export','WalletController@export')->name('user.admin.wallet.export');
});
