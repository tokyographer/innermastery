...
Route::group(['prefix'=>'user','middleware' => ['auth','verified']],function(){
    ...
    Route::get('/transfer/list','UserController@transfer_list')->name("vendor.transfer_list");
    Route::get('/transfer','UserController@transfer')->name("vendor.transfer");
    Route::post('/transfer','UserController@transfer_store')->name("vendor.transfer_store");
    Route::post('/transfer/check-email','UserController@transfer_check_email')->name("vendor.transfer_check_email");
