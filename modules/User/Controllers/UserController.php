...
class UserController extends FrontendController
{
    ...
    public function transfer_list(){
        ...
        return view('User::transfer.list', $data);
    }
    ...
    public function transfer(){
        ...
        return view('User::transfer.transfer', $data);
    }

    public function transfer_check_email(Request $request){
        $email = $request->input("email");
        $user = User::where("email", $email)->first();
        if(!$user) return ["status" => false, "msg" =>__('Email User Not Found')];
        return ["status" => true, "msg" =>__('Email User Found')];
    }
