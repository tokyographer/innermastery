...
class BookingController extends \App\Http\Controllers\Controller
{
    ...
    public function checkout($code)
    {
        ...
        $customer_id = Booking::with("customer")->where("code", $code)->first();
        $id_customer = $customer_id->customer_id;
        $balance = DB::select("SELECT * FROM user_wallets WHERE holder_id = $id_customer");
        $data = [
